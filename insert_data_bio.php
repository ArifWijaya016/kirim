...
$sql = "INSERT INTO $table (tekanan_tangki, tekanan_tabung, temperature, ph_bio, karbon_dioksida, karbon_monoksida, nama) VALUES (?, ?, ?, ?, ?, ? 'bio')";
...
$stmt->bind_param("ss", $tekanan_tangki, $tekanan_tabung, $temperature, $ph_bio, $karbon_dioksida, $karbon_monoksida);
